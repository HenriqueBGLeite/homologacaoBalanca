...
public class Bluetooth_DevicesCallback
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("InTheHand.Bluetooth.Bluetooth+DevicesCallback, InTheHand.BluetoothLE", Bluetooth_DevicesCallback.class, __md_methods);
	}

	public Bluetooth_DevicesCallback ()
	{
		super ();
		if (getClass () == Bluetooth_DevicesCallback.class) {
			mono.android.TypeManager.Activate ("InTheHand.Bluetooth.Bluetooth+DevicesCallback, InTheHand.BluetoothLE", "", this, new java.lang.Object[] {  });
		}
	}
