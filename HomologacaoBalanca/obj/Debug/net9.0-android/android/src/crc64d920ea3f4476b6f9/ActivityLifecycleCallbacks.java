...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("InTheHand.ActivityLifecycleCallbacks, InTheHand.AndroidActivity", ActivityLifecycleCallbacks.class, __md_methods);
	}
	...
	public ActivityLifecycleCallbacks ()
	{
		...
		if (getClass () == ActivityLifecycleCallbacks.class) {
			mono.android.TypeManager.Activate ("InTheHand.ActivityLifecycleCallbacks, InTheHand.AndroidActivity", "", this, new java.lang.Object[] {  });
		}
	}
